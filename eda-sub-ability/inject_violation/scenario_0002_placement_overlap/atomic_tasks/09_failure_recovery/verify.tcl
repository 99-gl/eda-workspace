...
if {[lindex [dbGet $anchor.pt] 0] ne {33.25 119.28} || [dbGet $anchor.orient] ne "MX"} { error "Anchor wrong" }
puts "PLACEMENT_ATOMIC_09_COMPLETE setup=$setup_slack hold=$hold_slack"
exit
